...
\vskip 3ex
\begin{tcolorbox}[fontupper=\Large,sharp corners, colback=gray!20, colframe=Aquamarine!10]
$ r(s_t,a_t) + \mathbb{E}_{s_{t+1} \sim P(\bullet \mid (s_t,a_t))} \left[\mathbb{V}_{s_{t+1}}\right] \text{ Use the sampled s_{t+1} }$
\end{tcolorbox}
\vskip 3ex
\begin{tcolorbox}[fontupper=\Large,sharp corners, colback=gray!20, colframe=Aquamarine!10]
